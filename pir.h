...
public:
    ...
    void Update(Matrix& D, Matrix& H, Matrix& D_, Matrix& H_, Matrix& A, UpdateType updateType, Matrix& array, uint64_t* index);

    void DBUpdate(Matrix& D, Matrix& out, UpdateType updateType, Matrix& array, uint64_t* index);
    void StateUpdate(Matrix& H, Matrix& out, Matrix& D, Matrix& A, UpdateType updateType, uint64_t* index, uint64_t m);
